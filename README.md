...
La página está en `index.html`, los estilos en `assets/css/site.css` y las interacciones en `assets/js/site.js`. El diseño utiliza Arial, verde de marca y amarillo sobre fondos claros. La cabecera lleva dos accesos, uno por seguro: «Seguro de salud · Calcula tu precio» (verde sólido, a la sección de ayuda) y «Responsabilidad civil obligatoria · Contrátala desde 39,90 €/año» (con borde, a la sección de precios). Hasta 820 px se oculta la etiqueta superior y hasta 600 px los dos botones pasan a una segunda fila bajo el logo. La sección «Cómo funciona» comparte la alineación y la escala de títulos de la web, con la fotografía de fondo a toda altura y a la derecha en escritorio. En móvil, la fotografía se oculta y la sección utiliza un fondo crema uniforme. Debajo, la sección «Precios» presenta el seguro de responsabilidad civil y asistencia de Línea Directa de forma compacta: qué es y por qué es necesario en dos columnas, y las dos modalidades (Esencial y Completo) con selector Perros/Gatos, detalle desplegable y botones «Contratar» que, tras un aviso (`#external-dialog`) de que se sale de la web, abren Línea Directa en una pestaña nueva con el código de mediador. Solo muestra información dirigida al cliente final.
